...
let employeePayrollData = new EmployeePayrollData(1, "Kalyan$", 50000,"male",new Date());
console.log(employeePayrollData.toString());
employeePayrollData.name = "Bhargav$";
console.log(employeePayrollData.toString());
let newemployeePayrollData = new EmployeePayrollData(2,"Simran$",70000,"Female",new Date());
